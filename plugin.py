...
from Plugins.Extensions.ElieSatPanelGrid.menus.Toolsp import Toolsp
...
class EliesatPanel(Screen):
    ...
    def __init__(self, session):
        ...
        self.menuList = [
            ...
            ("Tools-panels", "Explore E2 panels with developers links"),
            ("About", "About"),
...
def main(session, **kwargs):
    session.open(EliesatPanel)  # optionally rename to ElieSatPanelGridScreen
